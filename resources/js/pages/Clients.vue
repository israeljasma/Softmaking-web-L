<template>
    <div class="container mx-auto px-6 p-4 my-24">
        ...
        >
            ...
            <tbody class="flex-1 sm:flex-none">
                ...
                >
                    ...
                    <td
                        class="border-gray-200 border hover:bg-gray-100 p-2 h-12"
                    >
                        {{ client.name }}
                    </td>
                    <td
                        class="border-gray-200 border hover:bg-gray-100 p-2 h-12 overflow-ellipsis overflow-auto"
                    >
                        {{ client.description }}
                    </td>
                    <td
        ...
        <div
            v-else
            class="p-4 md:p-12 text-center bg-white shadow-sm md:border md:border-blue-600 rounded-md"
        >
...
export default {
    ...
    methods: {
        showSwalToast: function(title, icon, timer = 3000) {
            Vue.swal.fire({
                toast: true,
                icon,
                title,
        ...
        getClients: function() {
            axios
                ...
                .catch(error => {
                    this.showSwalToast("Ha ocurrido un error al cargar los clientes", "error", 3000)
                });
        },
        deleteClient: function(client) {
            Vue.swal({
                ...
                if (result.isConfirmed) {
                    axios
                        .delete(`/api/clients/${client.id}`, client)
                        .then(res => {
                            Vue.swal(
                                "Eliminado!",
