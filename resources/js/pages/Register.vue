    ...
    <div class="md:h-screen flex justify-center items-center px-6 my-24 md:my-0">
      <div class="w-full xl:w-3/4 lg:w-11/12 flex">
        <div
          ...
          style="background-image: url('imgs/register-bg.jpg')"
        ></div>
        <div class="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
          <h3 class="pt-4 text-2xl text-center font-semibold">Registrarse</h3>
          <form
            class="px-2 md:px-8 pb-8 mb-4 bg-white rounded"
            method="POST"
