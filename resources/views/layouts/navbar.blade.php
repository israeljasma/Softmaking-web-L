    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div id="mobile-menu" class="hidden md:block ml-auto">
                    <!-- Authentication Links -->
                    <div class="flex">
                        @guest
                            <div class="m-auto">
                                <a class="ml-3 px-3 py-2 rounded-md text-sm leading-5 text-gray-100 font-bold uppercase hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
                            ...
                            <div class="ml-auto">
                                <a class="mr-1 lg:ml-4 px-1 lg:px-3 py-2 rounded-md text-sm leading-5 text-gray-100 font-bold uppercase hover:text-white border border-gray-500 hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
                                    href="{{ route('login') }}">{{ __('Login') }}</a>
                                @if (Route::has('register'))
                                    <a class="lg:ml-4 px-1 lg:px-3 py-2 rounded-md text-sm leading-5 text-gray-100 font-bold uppercase hover:text-white border border-gray-500 hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
